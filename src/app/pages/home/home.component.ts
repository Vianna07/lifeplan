        ...
        topics: [
          {
            title: "O que é?",
            description: [
              "Esta seção pode oferecer uma visão geral do conceito de finanças pessoais, explicando a importância de gerenciar o dinheiro de forma eficaz."
            ]
          },
          {
            title: "CDB/CDI",
            description: [
              "Informações sobre investimentos em CDB (Certificado de Depósito Bancário) e CDI (Certificado de Depósito Interbancário), incluindo como funcionam e por que são importantes para o planejamento financeiro. Isso pode incluir detalhes sobre taxas de retorno, prazos de resgate e riscos associados."
            ]
          }
        ]
      },
        ...
        topics: [
          {
            title: "Carreira",
            description: [
              "Exploração de diferentes aspectos relacionados à carreira, como planejamento de carreira, desenvolvimento de habilidades e estratégias para avançar profissionalmente. Isso pode incluir conselhos sobre networking, elaboração de currículo e técnicas de entrevista."
            ]
          },
          {
            title: "Investimentos",
            description: [
              "Orientação sobre como planejar e gerenciar investimentos para alcançar metas financeiras de longo prazo, incluindo estratégias de alocação de ativos e diversificação. Isso pode incluir informações sobre diferentes tipos de investimentos, como ações, títulos e fundos mútuos, e como construir um portfólio diversificado."
            ]
          }
        ]
      }
