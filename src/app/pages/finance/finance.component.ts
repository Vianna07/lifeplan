    ...
    this.modules = [
      ...
      },
      {
        ...
        topics: [
          {
            title: "Taxa Selic:",
            description: "A Taxa Selic é a taxa básica de juros definida pelo Banco Central do Brasil, influenciando o rendimento de diversos investimentos, como Tesouro Selic e LCIs/LCAs. É utilizada como instrumento de política monetária para controlar a inflação e estimular a economia."
          },
          {
            title: "IPCA:",
            description: "O IPCA é o Índice Nacional de Preços ao Consumidor Amplo, utilizado como indicador oficial de inflação no Brasil. Investimentos como Tesouro IPCA e CDBs são indexados a este índice para proteção contra a desvalorização da moeda."
          },
          {
            title: "DI - Depósito Interfinanceiro:",
            description: "DI é a taxa média de juros praticada entre instituições financeiras para empréstimos de curtíssimo prazo, geralmente de um dia. É uma referência para diversos investimentos de renda fixa, como CDBs e Letras de Câmbio (LCs)."
          }
        ]
      },
      {
        ...
        topics: [
          {
            title: "IOF:",
            description: "O Imposto sobre Operações Financeiras é um tributo federal aplicado sobre diversas transações financeiras, como operações de crédito, câmbio, seguros e títulos e valores mobiliários. Tem como objetivo regular o mercado e controlar o fluxo de capital."
          },
          {
            title: "IR - Imposto de Renda:",
            description: "O Imposto de Renda é um tributo federal aplicado sobre a renda de pessoas físicas e jurídicas no Brasil. Incide sobre salários, lucros, rendimentos de investimentos, entre outros. Sua arrecadação é essencial para o financiamento de serviços públicos, como saúde, educação e segurança."
          }
        ]
      },
      {
        ...
        topics: [
          ...
          },
          {
            ...
            subTopics: [
              ...
              {
                title: "Ethereum:",
                description: "O Ethereum é uma plataforma de computação distribuída e uma criptomoeda chamada Ether (ETH). Lançada em 2015, ela permite a criação e execução de contratos inteligentes e aplicativos descentralizados (DApps). Flexível e altamente utilizado, o Ethereum está em processo de transição para um sistema de consenso de Prova de Participação (PoS). O Ether é a criptomoeda nativa usada na rede para pagar taxas de transação e recompensar os mineradores."
              }
            ]
          },
          {
